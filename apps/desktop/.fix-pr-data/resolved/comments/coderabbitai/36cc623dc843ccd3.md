...
**Resolution:** Comment suggests @components/* alias but tsconfig paths map @components to src/renderer/shared/components/* not src/renderer/components/ui/*. The UI components are not in the shared location and relative imports are the correct approach for this file structure.