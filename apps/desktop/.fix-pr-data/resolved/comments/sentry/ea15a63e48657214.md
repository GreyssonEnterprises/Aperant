...
**Resolution:** FALSE POSITIVE: Code correctly uses detailedStatus === 'discussions_not_resolved' || mrData.blocking_discussions_resolved === false at line 1094 - NOT using discussion_locked